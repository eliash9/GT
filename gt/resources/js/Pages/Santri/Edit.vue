...
const form = useForm({
    ...
    _method: 'PUT',
    haliyah_jabatan: props.santri.haliyah_jabatan ?? '',
    haliyah_keaktifan: props.santri.haliyah_keaktifan ?? '',
    haliyah_pelanggaran: props.santri.haliyah_pelanggaran ?? '',
    akademisi: props.santri.akademisi ?? '',
    kelas_formal: props.santri.kelas_formal ?? '',
    nilai_ujian_tulis: props.santri.nilai_ujian_tulis ?? '',
    nilai_ujian_materi: props.santri.nilai_ujian_materi ?? '',
    nilai_ujian_praktek_kelas: props.santri.nilai_ujian_praktek_kelas ?? '',
    marhalah_alquran: props.santri.marhalah_alquran ?? '',
    status_seleksi: props.santri.status_seleksi ?? 'Belum Diproses',
    status_kelulusan: props.santri.status_kelulusan ?? 'Belum Lulus',
});
