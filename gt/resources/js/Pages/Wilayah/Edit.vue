...
const form = useForm({
    nama: props.wilayah.nama,
    pjgt_id: props.wilayah.pjgt_id || '',
});

const submit = () => form.put(route('wilayahs.update', props.wilayah.id));
</script>
    ...
    <AuthenticatedLayout>
        <div class="max-w-xl">
            <div class="flex items-center gap-3 mb-6">
                ...
                <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Edit Data Wilayah</h1>
            </div>
